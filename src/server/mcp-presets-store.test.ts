...
beforeEach(() => {
  ...
  // getStateDir() resolves HERMES_HOME/workspace/<file> - fixtures must land
  // one directory deeper than homeDir itself, or readPresets() silently
  // finds nothing at the (wrong) shallower path and bootstraps from seed.
