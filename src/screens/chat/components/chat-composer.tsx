...
function ChatComposerComponent({
  ...
  // Auto-switch to hermes-agent model on mount (Valkhana uses Hermes Agent)
                            ...
                            {isWorkspaceMenuOpen && (
                              <div className="absolute bottom-full left-0 z-[200] mb-2 min-w-[14rem] overflow-hidden rounded-xl border border-neutral-200 bg-white p-1 shadow-xl animate-in fade-in slide-in-from-bottom-2 duration-150 dark:border-neutral-700 dark:bg-neutral-900">
                                ...
                                <button
                                  ...
                                  className="mt-1 w-full rounded-lg px-3 py-2 text-left text-xs text-primary-600 transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/60"
                                >
                                  Browse files&hellip;
                                </button>
                              </div>
