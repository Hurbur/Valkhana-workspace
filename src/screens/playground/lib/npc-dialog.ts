...
export const NPC_DIALOG: Record<string, NpcDialogTree> = {
  athena: {
    ...
    lore: [
      ...
      'Long before Valkhana, agents were tools. We invited them into a world instead.',
  ...
  apollo: {
    ...
    lore: [
      ...
      'When Valkhana ships music generation in a quest, I am the one composing.',
    ],
    choices: [
      {
        id: 'song-fragment',
  ...
  chronos: {
    ...
    lore: [
      ...
      'The cron jobs in Valkhana are also mine. I run on heartbeat.',
    ],
    choices: [
      {
        id: 'oracle-riddle',
  ...
  artemis: {
    ...
    lore: [
      'When you run a long agent task in Valkhana, it walks somewhere. I find it when it forgets to come home.',
