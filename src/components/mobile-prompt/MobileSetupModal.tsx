  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Valkhana, then sign in.',
    ...
    },
    {
      ...
      body: 'Valkhana can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open Valkhana on your phone',
      body:
