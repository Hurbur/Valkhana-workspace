        ...
        >
          {step === 'welcome' && (
            <div className="space-y-4 text-center">
              ...
              />
              <h2 className="text-xl font-bold">Welcome to Valkhana</h2>
          ...
          {step === 'connect' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                Start by verifying that Valkhana can reach your
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-xs" style={mutedStyle}>
                {canEditConfig
                  ...
                  : 'This backend manages provider settings outside Valkhana. Confirm the model you expect to use, then test chat.'}
              </p>
